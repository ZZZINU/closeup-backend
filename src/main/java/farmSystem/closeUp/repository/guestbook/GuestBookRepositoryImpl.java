...
public class GuestBookRepositoryImpl implements GuestBookRepositoryCustom {
    ...
    public Slice<GetGuestBooksResponse> findByGuestBooks(Long creatorId, Pageable pageable) {
        ...
        for(GuestBook findGuestBook : findGuestBooks) {
            result.add(GetGuestBooksResponse.of(findGuestBook.getGuestBookId(), findGuestBook.getGuestBookUserId(), findGuestBook.getGuestBookUserNickname(), findGuestBook.getGuestBookUserProfileImageUrl(), findGuestBook.getCreatedAt(), findGuestBook.getGuestBookContent()));
        }
